...
public class LogRegController {
	...
	public String signup(Model theModel)
	{
	 ...
	 @RequestMapping(value = "/testing1",method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 public ModelAndView savePatient(@ModelAttribute("patient") Patient thePat,Model theModel)
	 { 
		 ModelAndView mav=null;
		 
		 Patient pat = patientService.findByEmail(thePat.getEmail());
		 Doctor doc = doctorService.findByEmail(thePat.getEmail());
		 ...
		 if(pat==null & doc==null) {
			 ...
			 mav= new ModelAndView("patient-form");
			  mav.addObject("error", "Email already in use");
		 }
		 return mav;
